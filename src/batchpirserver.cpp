...
void BatchPIRServer::set_client_keys(uint64_t client_id, std::pair<seal::GaloisKeys, seal::RelinKeys> keys)
{
...
PIRResponseList BatchPIRServer::generate_response(uint64_t client_id, vector<PIRQuery> queries)
{
...
PIRResponseList BatchPIRServer::merge_responses(vector<PIRResponseList> &responses, uint64_t client_id)
{
